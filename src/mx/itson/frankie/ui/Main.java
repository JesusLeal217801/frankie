...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        receta.setDescripcion("Hornea una receta de FRANKIE BROWNIES "
                + "con Leche Condensada LA LECHERA® para este Halloween "
                + "y ofrécelas en tu reunión, con amigos, o con tu familia.");
